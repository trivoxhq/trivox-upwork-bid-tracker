                    ...
                    {pinRequired ? (
                      <div className="mt-4">
                        ...
                        <input
                          ...
                          className={`mt-2 w-full rounded-lg border border-border bg-bg-primary px-3 py-2.5 text-sm text-text-primary shadow-sm outline-none transition-[border-color,box-shadow] duration-200 focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/15`}
                          disabled={submitting}
                        />
                      </div>
                    ) : null}
