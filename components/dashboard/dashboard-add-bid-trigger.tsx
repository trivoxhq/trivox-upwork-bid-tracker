    ...
    return (
      <>
        <button
          ...
          title={label}
          aria-label={label}
          className={`inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-brand-primary bg-brand-primary text-white shadow-md shadow-brand-primary/25 hover:border-brand-hover hover:bg-brand-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/35 ${DASH_TRANSITION} ${className}`}
        >
  ...
  return (
    <>
      <button
        type="button"
        onClick={() => setOpen(true)}
        className={`inline-flex min-h-[44px] w-full sm:w-auto items-center justify-center rounded-lg border border-brand-primary bg-brand-primary px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:border-brand-hover hover:bg-brand-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/35 ${DASH_TRANSITION} ${className}`}
      >
        {label}
      </button>
      <AddBidModal
